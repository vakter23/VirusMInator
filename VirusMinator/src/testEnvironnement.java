...
public class testEnvironnement {
	...
	public void setUp() throws Exception{
		...
		TourelleSavonneuse t5 = new TourelleSavonneuse(48,48,env);
		this.env.ajouterTourelles(t5);

	}
	@Test
	public void listeRempli(){
//		testliste.add(v1);
//		testliste.add(v2);
//		testliste.add(v3);
		...
		assertTrue(env.getViruses().size()==3);
	}
//	@Test
//	public void test() {
