...
public class Acteurs {
    ...
    public Acteurs(int vie,double vitesse,String nom, int x,int y) { /*Constructeur Virus*/
    ...
    public Acteurs(int atq,int portée,double atqSpeed,String nom, int x, int y) { /*Constructeur tourelles*/
    ...
    public Acteurs(int atq, int portée, double atqSpeed, String nom, String position) {
    	this.atq=atq;
        this.portée=portée;
        this.atqSpeed=atqSpeed;
        this.nom=nom;
