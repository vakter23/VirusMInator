...
//			System.out.println(this.getId() + "y : " + this.getY() + "\n");
			...
			if (this.getYproperty().getValue() >= 288
					&& this.getXproperty().getValue() >= 1104) {/*
																 * Infliger des dégats à l'hopital
																 */
				/*
				...
				v.infligerDegats(v.getAtq());
				/*
				 * créer methode creer tir en abstraite pour factoriser le code (Public Tir
				 * creerTir(){}
				 

			}
		} /*
			 * On aurait pu faire une classe effet avec des sous classes et les ajouter en
			 * tant qu'attribut
